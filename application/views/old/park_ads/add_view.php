...
if($park_add_id != 0 ) {
    $full_url = base_url().'park_ads/add/'.$park_add_id;
}
else {
    $full_url = base_url().'park_ads/add/';    
}
...
?>
    <div class="row well">
			<?php if($park_add_id != 0 ) {?>
					<legend><label class="default_font_color">Create New Business Park Ads</label>
					...
					<div class="col-lg-4">
						 <?php echo "<select name='park_id' class='hidden'><option value=".$park_add_id." ></option></select>";?>
					</div>
					<div class="col-lg-6">   
			...
			<?php }
					...
					if(!empty($park['list'])){?>
					   ...
					   <div class="col-lg-4">
							...
							<?php foreach($park['list']  as $key=>$value) {?>
							<option value="<?php echo $park['list'][$key]->park_id;?>"><?php echo $park['list'][$key]->park_name; ?></option>
							<?php } ?>
							</select>
						</div>
						<div class="col-lg-6">   
				    ...
				    <?php }
						...
						<div class="col-md-12 text-center">
							<h3>No Business Parks Found.Please Add Business Parks First</h3>
							<a href="<?php echo base_url()?>parks">Go back to Business Park</a>
						</div>	
				    <?php }
			} ?>
