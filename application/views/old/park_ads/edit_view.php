<?php
    ...
    $full_url = base_url().'park_ads/edit/'.$ad_id;
...
?>
    <div class="row well">
        <legend><label class="default_font_color">Update Business Park Add</label>
            ...
            <div class="col-lg-4">
                ...
                <?php if(!empty($park['list'])) {
                foreach($park['list']  as $key=>$value)
                {?>
                <option value="<?php echo $park['list'][$key]->park_id;?>"><?php echo $park['list'][$key]->park_name; ?></option>
                <?php }
                }
                else{?>
                    <option>No Business Park To Show</option>
                <?php } ?>
                </select>
            </div>
    	   <div class="col-md-6">
                <div class="col-md-4">
                    <img src="<?php echo asset_url()."uploads/park_ads/".$ref_image; ?>" class="img-responsive img-thumbnail" width="100px;"/>
                </div>
                <div class="col-md-8">
