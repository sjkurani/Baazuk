<?php
    ...
    $full_url = base_url().'radio_ads/edit/'.$ad_id;
...
?>
    <div class="row well">
         <legend><label class="default_font_color">Update Radio Station Add</label>
			...
			<div class="col-lg-4">
             ...
             <div class="col-md-6">
                <div class="col-md-4">
                    <img src="<?php echo asset_url()."uploads/radio_ads/".$ref_image; ?>" class="img-responsive img-thumbnail" width="100px;"/>
                </div>
                <div class="col-md-8">
...
<label>Option Image</label><small> (Image max size:2MB & Image type: gif, jpg, png.)</small>
            ...
            <div class="col-lg-12">
                ...
                <textarea name="ad_desc" class="form-control" rows="8" cols="50"><?php echo $ad_desc;?></textarea>
            </div>
