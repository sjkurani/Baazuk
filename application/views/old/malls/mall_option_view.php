...
?>	
	<legend class="text-center"><label>Malls options</label></legend>
	...
	<div class="row ">
		...
		<div class="col-sm-4 col-lg-4 col-md-4">
			...
			<div class="row">
				...
				echo "<div class='col-lg-4'> <span class=''><a  class='btn btn-info' href='".base_url()."mall_ads/edit/".$result['secondary'][$key]->ad_id."'>Edit</a></span></div>"; 
				echo "<div class='col-lg-4'> <span class=''><a  class='btn btn-danger' href='".base_url()."mall_ads/delete_mall_ads/".$result['secondary'][$key]->ad_id."/3'>Delete</a></span></div>";  
				echo "<div class='col-lg-4'><span><a  class='btn btn-warning' href='".base_url()."mall_ads/change_mall_ads_status/".$result['secondary'][$key]->ad_id."/2'>Block</a></span></div>";
