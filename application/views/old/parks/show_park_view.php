...
<div class="section light directory-single">
       <h3 class="show_text main_title"><?php $str = $result['primary'][0]->park_name." - BP".$result['primary'][0]->park_id;
       echo ucwords ($str); ?>
     
       	
       </h3> 
       <h5> <span><?php echo $result['primary'][0]->park_cityname; ?></span>  </h5>
		<div class="row col-md-6 col-lg-6 col-sm-6">
			<div class="mainfunctionimg1">
			<img src="<?php echo $park_img_name;?>" />
			</div>
		</div>
		...
		<div class="col-md-12 col-sm-12">
			<section style="margin-top:2em;">
                      <h3 class="show_text row"> About Business Park</h3>  
                        <ul class="tags">
                           <li class="tag">Companies : <?php echo $result['primary'][0]->key_companies; ?></li>
                          <li class="tag"> Employee Strength : <?php echo $result['primary'][0]->employee_strenght; ?></li>

                          <li class="tag"> Registered : <?php echo date("d-M-Y", strtotime($result['primary'][0]->created)); ?></li>  
                        </ul>
                        <h4 class="show_text row">Description</h4>
               <p class="row">   <?php echo $result['primary'][0]->park_desc; ?></p>
            </section>    
		</div>
	</div>

<h3 class="show_text row"> Park options</h3>
		 ...
		 <div class="row col-sm-4 col-lg-4 col-md-4">
			<div class="thumbnail1">
				<a data-target="<?php echo '#'.$read_target; ?>" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#myModal"><img class="options_img" src="<?php echo $img_url;?>" alt="<?php echo $result['secondary'][$key]->ad_title;?>">
                 <div class="desc"><br>
					<h4><?php $str = $result['secondary'][$key]->ad_title." - BP".$result['primary'][0]->park_id."00".$result['secondary'][$key]->ad_id;
       echo ucwords ($str); ?>
					...
					<div class="col-lg-6">
						...
						if($is_autorised) {
							if(in_array($result['secondary'][$key]->ad_id, $saved_array)) {
								...
								$url_str = base_url()."save_ad/save/".$result['secondary'][$key]->ad_id."/park/".$result['primary'][0]->park_id;
...
<div class="col-sm-12 col-md-12 col-lg-12 media_desc">
	...
	<script>
		...
		var lat_lng=arr[0].park_location;
		console.log(lat_lng);
        var map;
        var temp ;
		temp = lat_lng;
