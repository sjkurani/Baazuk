                          ...
                          foreach ($parks['new'] as $key => $value) {
	            			...
	            			echo "<legend>
                               ...
                               <label><a href=".base_url()."parks/show/".$parks['new'][$key]->park_id.">".$parks['new'][$key]->park_name." -BP".$parks['new'][$key]->park_id."</a></label>	
	            				...
	            				<span class='pull-right'><a  class='btn btn-info' href='parks/edit/".$parks['new'][$key]->park_id."'>Edit</a></span>";


                             if($user_type =='admin') 

                                  {
                                    echo "<span class='pull-right'><a  class='btn btn-success' href='parks/change_parks_status/".$parks['new'][$key]->park_id."/1'>Activate</a></span>";
	            ...
	            <section  class="tab-pane fade in" id="actviePanel">
	            	...
	            	if(!empty($parks['active'])) {
	            			...
	            			<label><a href=".base_url()."parks/show/".$parks['active'][$key]->park_id.">".$parks['active'][$key]->park_name." -BP".$parks['active'][$key]->park_id."</a></label>
	            				...
	            				<span class='pull-right'><a  class='btn btn-warning' href='parks/change_parks_status/".$parks['active'][$key]->park_id."/2'>Block</a></span>

	            				<span class='pull-right'><a  class='btn btn-danger' href='".base_url()."parks/delete_parks/".$parks['active'][$key]->park_id."/3'>Delete</a></span>
	            				
                                  <span class='pull-right'><a  class='btn btn-success' href='".base_url()."recommend/save_rec_media/park/".$parks['active'][$key]->park_id."'>Recommended</a></span>

                                 <span class='pull-right'><a  class='btn btn-success' href='".base_url()."parks/view/".$parks['active'][$key]->park_id."'>View options</a></span>
	            ...
	            <section  class="tab-pane fade in" id="blockedPanel">
	            	...
	            	if(!empty($parks['blocked'])) {
	            		...
	            		<label><a href=".base_url()."parks/show/".$parks['blocked'][$key]->park_id.">".$parks['blocked'][$key]->park_name." -BP".$parks['blocked'][$key]->park_id."</a></label>
	            				...
	            				<span class='pull-right'><a  class='btn btn-danger' href='parks/delete_parks/".$parks['blocked'][$key]->park_id."/3'>Delete</a></span>";

                              if($user_type =='admin') 

                                  {
                                    echo " <span class='pull-right'><a  class='btn btn-success' href='parks/change_parks_status/".$parks['blocked'][$key]->park_id."/1'>Reactivate</a></span>";
