               ...
               <section  class="tab-pane fade in active" id="newPanel">
                    ...
                    if(!empty($apartments['active'])) {
                        foreach ($apartments['active'] as $key => $value) {
                            ...
                            <label><a href=".base_url()."apartments/show/".$apartments['active'][$key]->a_id.">".$apartments['active'][$key]->a_name."</a></label>
                                ...
                                if(in_array($apartments['active'][$key]->a_id, $saved_recomanded)) {
                                    echo "<span class='pull-right'><a class='btn btn-success center-block'  href='#'> Recommended </a></span>";
                                }
                                else {
                                    $url_str = base_url()."recommend/save_rec_media/apartment/".$apartments['active'][$key]->a_id;
                                    echo "<span class='pull-right'><a class='btn btn-warning center-block'  href=".$url_str."> Recommend </a></span class='pull-right'>";
                                }
                                echo "<span class='pull-right'><a  class='btn btn-success' href='".base_url()."apartments/view/".$apartments['active'][$key]->a_id."'>View options</a></span>
                        ...
                        echo "<label class='no_result'>No Active apartments found here.</label>";
                    }
                    ?>
                </section>
                <section  class="tab-pane fade in" id="blockedPanel">
                    ...
                    if(!empty($apartments['blocked'])) {
                        ...
                        echo "<label class='no_result'>No Blocked apartments found here.</label>";
                    }
                    ?>
                </section>
