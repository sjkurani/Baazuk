...
echo "</ul>";
    ...
    foreach ($recomanded['radio'] as $key => $value) {
        $saved_recomanded[] = $value->radio_station_id;
    }
?>
<legend class="text-right"><label><a href="<?php echo base_url().'radio/add'; ?>" class='btn hoverable_btn'>Add New Radio Station</a></label></legend>
                    ...
                    if(!empty($radios['new'])) {
                           ...
                           foreach ($radios['new'] as $key => $value) {
                            ...
                            <label><a href=".base_url()."radio/show/".$radios['new'][$key]->radio_station_id.">".$radios['new'][$key]->radio_station_name." -R".$radios['new'][$key]->radio_station_id."</a></label>
                                ...
                                <span class='pull-right'><a  class='btn btn-info' href='".base_url()."radio/edit/".$radios['new'][$key]->radio_station_id."'>Edit</a></span>";


                              if($user_type =='admin') 

                                  {
                                    echo " <span class='pull-right'><a  class='btn btn-success' href='".base_url()."radio/change_radios_status/".$radios['new'][$key]->radio_station_id."/1'>Activate</a></span>";
                         ...
                         foreach ($radios['active'] as $key => $value) {
                            ...
                            echo "<legend>
                             ...
                             <label><a href=".base_url()."radio/show/".$radios['active'][$key]->radio_station_id.">".$radios['active'][$key]->radio_station_name." -R".$radios['active'][$key]->radio_station_id."</a></label>
                                ...
                                <span class='pull-right'><a  class='btn btn-warning' href='".base_url()."radio/change_radios_status/".$radios['active'][$key]->radio_station_id."/2'>Block</a></span>
...
/*
                                ...
                                if(in_array($radios['active'][$key]->radio_station_id, $saved_recomanded)) {
                                    echo "<span class='pull-right'><a class='btn btn-success center-block'  href='#'> Recommended </a></span>";
                                }
                                else {
                                    $url_str = base_url()."recommend/save_rec_media/radio/".$radios['active'][$key]->radio_station_id;
                                    echo "<span class='pull-right'><a class='btn btn-warning center-block'  href=".$url_str."> Recommend </a></span class='pull-right'>";
                                }
                                echo "<span class='pull-right'><a  class='btn btn-success' href='".base_url()."radio/view/".$radios['active'][$key]->radio_station_id."'>View options</a></span>
                        ...
                        echo "<label class='no_result' >No Active radios found here.</label>";
                    }
                    ?>
                </section>
