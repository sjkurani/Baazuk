<?php
    ...
    $full_url = base_url().'event_ads/edit/'.$ad_id;
...
?>
    ...
    <div class="row well">
        ...
        <legend><label class="default_font_color">Update Events and Exhibition Option</label>
           ...
           <div class="col-lg-4">
			...
			<div  class="col-lg-4">
                <label>Events and Exhibition Name <i class="required"> * </i> </label>
				<select name="event_id" class="form-control">
				
				<?php if(!empty($event['list'])) {
				...
				<?php }
					...
					<option>No Events and Exhibition To Show</option>
				<?php }	?>
				</select>
            </div>
			<div  class="col-lg-4">
        ...
        <div class="col-md-7">
            <div class="col-md-4">
                <img src="<?php echo asset_url()."uploads/event_ads/".$ref_image; ?>" class="img-responsive img-thumbnail" width="100px;"/>
            </div>
            <div class="col-md-8">
