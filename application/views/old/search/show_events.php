							...
							<div class="col-md-12 well">
								...
								<div class="col-md-6 mainscroll">
									...
									<div class="row thumbnail" onmouseover="showme(<?php echo $i; ?>)" onmouseout="showme(<?php echo $i; ?>)" id="markers_info" >
										<div class="col-md-4" >
											<div class="">
												<img class="img-thumbnail myimg" src="<?php echo base_url()?>assets/uploads/events/<?php echo $list['data'][$key]->event_image; ?>" >
											</div>
										</div>
										<div class="col-md-8 nopadding"">
											<a href="<?php echo base_url().'events/show/'.$list['data'][$key]->event_id; ?> ">
												<div class="col-md-12  purple-text"><?php echo ucwords($list['data'][$key]->event_name); ?></div>
												<div class="col-md-12"><?php echo ucwords($list['data'][$key]->event_cityname); ?>&nbsp;>>&nbsp;<?php echo $list['data'][$key]->event_area; ?></div>	
												<div class="col-md-12">
												<?php if(strlen($list['data'][$key]->event_desc) > 100)
													echo substr($list['data'][$key]->event_desc,0,100).'<a href='.base_url().'events/show/'.$list['data'][$key]->event_id.'> ...Read More</a>';
													  else
															echo $list['data'][$key]->event_desc; ?>
												</div>
											</a>
										</div>
									</div>
  ...
  <div class="directory-filters">
       <form action="<?php echo base_url()?>search/show" method="get">
			<input type="hidden" value="<?php echo $table;?>" name="media_type">
				...
				<input class="form-control"  type="text" value="<?php echo $area;?>" name="area">
				</div>
				<div class="col-md-3"><label>Keyword</label>
				<input class="form-control"  type="text" name="title" value="<?php echo $title;?>">
				</div>
				<div class="col-md-3"><label>&nbsp</label>
				<input  class="form-control btn btn-purple"  type="submit" value="Modify Search">
				</div>
		</form>
                ...
                <div onmouseover="showme(<?php echo $i; ?>)" onmouseout="showme(<?php echo $i; ?>)" id="markers_info" >              
					<div class="col-sm-6">
						<div class="directory-item category-box">
                            <img src="<?php echo base_url()?>assets/uploads/events/<?php echo $list['data'][$key]->event_image; ?>" alt="bg" class="img-responsive">
                               <div class="overlay inner">                               	
                               </div>
                               <div class="content">                                
									<h3 style="font-weight:bold;"><a href="<?php echo base_url().'events/show/'.$list['data'][$key]->event_id; ?>"><?php echo ucwords($list['data'][$key]->event_name); ?></a></h3>
									
									
									<div class="location"><img src="<?php echo base_url()."images/directory-location.png"; ?>" alt="location"><?php echo ucwords($list['data'][$key]->event_cityname); ?>&nbsp;>>&nbsp;<?php echo $list['data'][$key]->event_area; ?>
									</div>
								</div> 	
							</div>
