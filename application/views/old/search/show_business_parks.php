<head>
	...
	<script>
		...
		lat_lng_arr[index] = data.park_location;
			...
			<?php if(!empty($list['data'])){?>
				<div class="row">
							<div class="col-md-12 well">
									...
									<?php $arr=$list['data'];
									//echo ($arr[0]->park_cityname);?>
									<h1 style="text-align:center">List of Business Parks in City</h1><?php //echo @$arr[0]->park_cityname; ?>
									<div class="col-md-6">
									...
									<div class="col-md-6 mainscroll">
										...
										<div class="row thumbnail" onmouseover="showme(<?php echo $i; ?>)" onmouseout="showme(<?php echo $i; ?>)" id="markers_info" >
											<div class="col-md-3" >
												<div class="">
													<img class="img-thumbnail myimg" src="<?php echo base_url()?>assets/uploads/parks/<?php echo $list['data'][$key]->park_image ;?>" >
												</div>
											</div>
											<div class="col-md-9">
												<a class="" href="<?php echo base_url().'parks/show/'.$list['data'][$key]->park_id; ?> ">
													<div class="col-md-12 purple-text" ><?php echo ucwords($list['data'][$key]->park_name);?></div>
													<div class="col-md-12"><?php echo $list['data'][$key]->park_cityname ;?>&nbsp;-&nbsp;<?php echo $list['data'][$key]->park_area ;?></div>
													<div class="col-md-12">
														<?php if(strlen($list['data'][$key]->park_desc) > 100)
															echo substr($list['data'][$key]->park_desc,0,100).'<a href='.base_url().'parks/show/'.$list['data'][$key]->park_id.'> ...Read More</a>';
															else
																echo $list['data'][$key]->park_desc; ?>
													</div>
												</a>
											</div>
										</div>
				...
				<div class="row well no_result" style="text-align:center">
								...
								<a href="<?php echo base_url()?>home">Go back to Home Page</a>
				</div>				
				<?php } ?>
		</div>
</div>
                     ...
                     <div onmouseover="showme(<?php echo $i; ?>)" onmouseout="showme(<?php echo $i; ?>)" id="markers_info" >
						<div class="col-sm-6">
						 <div class="directory-item category-box">
                               ...
                               <img src="<?php echo base_url()?>assets/uploads/parks/<?php echo $list['data'][$key]->park_image ;?>" alt="bg" class="img-responsive">

                               <div class="overlay inner"></div>
                                <div class="content">
                                
									<h3 style="font-weight:bold;"><a href="<?php echo base_url().'parks/show/'.$list['data'][$key]->park_id; ?>"><?php echo ucwords($list['data'][$key]->park_name);?></a></h3>
									
									
									<div class="location"><img src="<?php echo base_url()."images/directory-location.png"; ?>" alt="location"><?php echo $list['data'][$key]->park_cityname ;?>&nbsp;-&nbsp;<?php echo $list['data'][$key]->park_area ;?>
									</div>
								</div> 	
							</div>
