...
?>
	...
	<legend class="text-center"><label>Events and Exhibition options</label></legend>
	...
	<div class="row ">
		...
		<div class="col-sm-4 col-lg-4 col-md-4">
			...
			<div class="row">
				<?php				
					echo "<div class='col-lg-4'> <span ><a  class='btn btn-info' href='".base_url()."event_ads/edit/".$result['secondary'][$key]->ad_id."'>Edit</a></span></div>";  
					echo "<div class='col-lg-4'> <span ><a  class='btn btn-danger' href='".base_url()."event_ads/delete_event_ads/".$result['secondary'][$key]->ad_id."/3'>Delete</a></span></div>";    
		             echo "<div class='col-lg-4'> <span><a  class='btn btn-warning' href='".base_url()."event_ads/change_event_ads_status/".$result['secondary'][$key]->ad_id."/2'>Block</a></span></div>";
					?>
