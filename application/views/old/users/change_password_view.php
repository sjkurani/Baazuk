...
?>
	<div class="row">
	<div class="col-md-12 " style="text-align:center"><h3>Change Password</h3></div>
...
&nbsp;
		...
		<div class="panel panel-info">
            <div class="pan-heading">
              <h3 class="panel-title"><?php //echo $result->fullname; ?></h3>
            </div>
			 <div class="panel-body">
			  ...
			  <div class=" col-md-9 col-lg-9 "> 
                  <table class="table table-user-information">
                    <tbody>
					<form action="<?php echo base_url().'users/change_password/'.$user_id;?>" method="post">
