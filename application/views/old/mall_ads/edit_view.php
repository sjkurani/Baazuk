<?php
    ...
    $full_url = base_url().'mall_ads/edit/'.$ad_id;
...
?>
    ...
    <div class="row well">
       <legend><label class="default_font_color">Update Mall Option</label>
            ...
            <div class="col-md-7">
                <div class="col-md-4">
                    <img src="<?php echo asset_url()."uploads/mall_ads/".$ref_image; ?>" class="img-responsive img-thumbnail" width="100px;"/>
                </div>
                <div class="col-md-8">
