...
<?php
    ...
    ?>
<legend class="text-center"><h2>List of Apartment Enquiries</h2></legend>
                                ...
                                <div class="row">
                                    <div class="text-center">
                                        <ul class="nav nav-pills nav-justified underlined" >
                                                <li class="active"><a href="<?php echo base_url()?>enquiries/" >Apartments</a></li>
                                                ...
                                                <section  class="tab-pane fade in active" id="media1">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($enquiry_list['apartment'] as $key => $value) {
                                                                ...
                                                                <a data-target="#popupmodal"  class="popup" id="'.$value->enquiry_id."-".$value->remarks."-".$value->flag.'" data-toggle="modal" href="#popupmodal."> Review </a></td>': '<td></td>';
