...
<?php
    ...
    ?>
<legend class="text-center"><h2>List of Radio Enquiries</h2></legend>
                                ...
                                <div class="row">
                                    <div class="text-center">
                                        <ul class="nav nav-pills nav-justified underlined" >
                                                ...
                                                <li class="active"><a href="<?php echo base_url()?>enquiries/radios" >Radio</a></li>
                                        ...
                                        <div class="panel-body">
                                            <div class="tab-content row">
                                                ...
                                                <section  class="tab-pane fade in active" id="media4">
