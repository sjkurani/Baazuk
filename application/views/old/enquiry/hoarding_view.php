...
<?php
    ...
    ?>
<legend class="text-center"><h2>List of Hoarding Enquiries</h2></legend>
                                ...
                                <div class="row">
                                    <div class="text-center">
                                       <ul class="nav nav-pills nav-justified underlined" >
                                                ...
                                                <li class="active"><a href="<?php echo base_url()?>enquiries/hoardings">Hoardings</a></li>
                                        </ul>
                                        <div class="panel-body">
                                            <div class="tab-content row">
                                                

                                                <section  class="tab-pane fade in active" id="media6">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            <label>Remarks : 
                                <input type="text" name="remarks" id="remarks" required="" class="form-control col-lg-12">
                               </textarea>
                            </label>
                        </div>
                    </div>
