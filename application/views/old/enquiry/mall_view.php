...
<?php
    ...
    ?>
<legend class="text-center"><h2>List of Mall Enquiries</h2></legend>
                                ...
                                <div class="row">
                                    <div class="text-center">
                                        <ul class="nav nav-pills nav-justified underlined" >
                                                ...
                                                <li class="active"><a href="<?php echo base_url()?>enquiries/malls" >Malls</a></li>
                                        ...
                                        <div class="panel-body">
                                            <div class="tab-content row">
                                                ...
                                                <section  class="tab-pane fade in active" id="media3">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body row">
                    <form action="<?php echo base_url().'enquiries/review'; ?>" method="post" novalidate>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            <label>Remarks : 
                                <input type="text" name="remarks" id="remarks" autofocus="true" required="" class="form-control col-lg-12" />
