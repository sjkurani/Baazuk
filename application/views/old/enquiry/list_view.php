                                ...
                                <div class="row">
                                    <div class="text-center">
                                        <ul class="nav nav-pills nav-justified underlined">
                                                <li class="active"><a href="#media1" data-toggle="tab" aria-expanded="true">Apartments</a></li>
                                                <li class=""><a href="#media2" data-toggle="tab" aria-expanded="false">Events</a></li>
                                                <li class=""><a href="#media3" data-toggle="tab" aria-expanded="false">Malls</a></li>
                                                <li class=""><a href="#media4" data-toggle="tab" aria-expanded="false">Radio</a></li>
                                                <li class=""><a href="#media5" data-toggle="tab" aria-expanded="false">Business Parks</a></li>
                                                <li class=""><a href="#media6" data-toggle="tab" aria-expanded="false">Hoardings</a></li>
                                        </ul>
